...
//
func Sgbmv(tA Transpose, m, n, kL, kU int, alpha float32, a []float32, lda int, x []float32, incX int, beta float32, y []float32, incY int) {
...
//
// Float32 implementations are autogenerated and not directly tested.
func Strmv(ul Uplo, tA Transpose, d Diag, n int, a []float32, lda int, x []float32, incX int) {
...
//
// Float32 implementations are autogenerated and not directly tested.
func Strsv(ul Uplo, tA Transpose, d Diag, n int, a []float32, lda int, x []float32, incX int) {
	if ul != Lower && ul != Upper {
		panic(badUplo)
	}
	if tA != NoTrans && tA != Trans && tA != ConjTrans {
...
//
// Float32 implementations are autogenerated and not directly tested.
func Ssymv(ul blas.Uplo, n int, alpha float32, a []float32, lda int, x []float32, incX int, beta float32, y []float32, incY int) {
